...
imagen = cv2.imread('Clasificacion de Imagenes/Images/Hojas/enfermas/Training/aiZwaWQ9QXBp.jpg')
...
paths=['Clasificacion de Imagenes/Images/Hojas/enfermas/Training/',
'Clasificacion de Imagenes/Images/Hojas/saludables/Training/'
]
labels=[]
features=[]
...
RUTA_IMAGEN = 'Clasificacion de Imagenes/Images/Hojas/saludables/Training/NCZwaWQ9QXBp13.jpg'
